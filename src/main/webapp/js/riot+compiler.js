...
(function (global, factory) {
    ...
    function parseExpressions(root, mustIncludeRoot) {
        ...
        walkNodes(root, function (dom) {
            ...
            // text node
            if (type === 3 && dom.parentNode.tagName !== 'STYLE' && tmpl.hasExpr(dom.nodeValue)) { expressions.push({ dom: dom, expr: dom.nodeValue }); }
            ...
            if (tagImpl && (dom !== root || mustIncludeRoot)) {
                if (isVirtual) { // handled in update
                    if (getAttr(dom, IS_DIRECTIVE)) { warn(("Virtual tags shouldn't be used together with the \"" + IS_DIRECTIVE + "\" attribute - https://github.com/riot/riot/issues/2511")); }
    ...
    */
    ...
    function mkdom(tmpl, html, isSvg$$1) {
        ...
        else { setInnerHTML(el, tmpl, isSvg$$1); }
