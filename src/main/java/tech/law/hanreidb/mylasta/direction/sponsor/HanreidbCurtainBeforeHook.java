 ...
 * @author jflute
 */
public class HanreidbCurtainBeforeHook implements CurtainBeforeHook {
    ...
    protected DfFinalTimeZoneProvider createFinalTimeZoneProvider() {
        return new DfFinalTimeZoneProvider() {
            protected final TimeZone provided = HanreidbUserTimeZoneProcessProvider.centralTimeZone;
