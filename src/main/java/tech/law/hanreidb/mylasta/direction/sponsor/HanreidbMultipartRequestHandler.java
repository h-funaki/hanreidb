 ...
 */
package tech.law.hanreidb.mylasta.direction.sponsor;
 ...
 */
public class HanreidbMultipartRequestHandler implements MultipartRequestHandler {

    // ===================================================================================
    //                                                                          Definition
    //                                                                          ==========
    private static final Logger logger = LoggerFactory.getLogger(HanreidbMultipartRequestHandler.class);
    ...
    protected void throwTooLongBoundarySizeException(String contentType, int boundarySize, int limitSize) {
        ...
        br.addElement(" in " + HanreidbMultipartRequestHandler.class.getSimpleName() + ".");
