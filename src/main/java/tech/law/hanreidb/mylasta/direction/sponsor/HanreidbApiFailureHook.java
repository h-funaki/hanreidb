...
import tech.law.hanreidb.mylasta.direction.sponsor.HanreidbApiFailureHook.UnifiedFailureResult.FailureErrorPart;
 ...
 * @author jflute
 */
public class HanreidbApiFailureHook implements ApiFailureHook { // #change_it for handling API failure
