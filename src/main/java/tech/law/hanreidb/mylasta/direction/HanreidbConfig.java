 ...
 * @author FreeGen
 */
public interface HanreidbConfig extends HanreidbEnv {
    ...
    String COOKIE_REMEMBER_ME_HANREIDB_KEY = "cookie.remember.me.hanreidb.key";
    ...
    /**
     * Get the value for the key 'cookie.remember.me.hanreidb.key'. <br>
     * The value is, e.g. HRB <br>
     * comment: The cookie key of remember-me for Hanreidb #change_it_first
     * @return The value of found property. (NotNull: if not found, exception but basically no way)
     */
    String getCookieRememberMeHanreidbKey();

    /**
     * The simple implementation for configuration.
     * @author FreeGen
     */
    public static class SimpleImpl extends HanreidbEnv.SimpleImpl implements HanreidbConfig {

        /** The serial version UID for object serialization. (Default) */
        private static final long serialVersionUID = 1L;

        public String getDomainName() {
            return get(HanreidbConfig.DOMAIN_NAME);
        }

        public String getDomainTitle() {
            return get(HanreidbConfig.DOMAIN_TITLE);
        }

        public String getAppStandardDatePattern() {
            return get(HanreidbConfig.APP_STANDARD_DATE_PATTERN);
        }

        public String getAppStandardDatetimePattern() {
            return get(HanreidbConfig.APP_STANDARD_DATETIME_PATTERN);
        }
        ...
        public String getCookieDefaultPath() {
            return get(HanreidbConfig.COOKIE_DEFAULT_PATH);
        }

        public String getCookieDefaultExpire() {
            return get(HanreidbConfig.COOKIE_DEFAULT_EXPIRE);
        }

        public Integer getCookieDefaultExpireAsInteger() {
            return getAsInteger(HanreidbConfig.COOKIE_DEFAULT_EXPIRE);
        }

        public String getCookieEternalExpire() {
            return get(HanreidbConfig.COOKIE_ETERNAL_EXPIRE);
        }

        public Integer getCookieEternalExpireAsInteger() {
            return getAsInteger(HanreidbConfig.COOKIE_ETERNAL_EXPIRE);
        }

        public String getCookieRememberMeHanreidbKey() {
            return get(HanreidbConfig.COOKIE_REMEMBER_ME_HANREIDB_KEY);
        }
    }
}
