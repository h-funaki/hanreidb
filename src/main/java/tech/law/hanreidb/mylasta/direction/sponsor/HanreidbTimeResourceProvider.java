 ...
 * @author jflute
 */
public class HanreidbTimeResourceProvider extends TypicalTimeResourceProvider {

    // ===================================================================================
    //                                                                           Attribute
    //                                                                           =========
    protected final HanreidbConfig config;

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public HanreidbTimeResourceProvider(HanreidbConfig config) {
        this.config = config;
    }
    ...
    protected TimeZone getCentralTimeZone() {
        return HanreidbUserTimeZoneProcessProvider.centralTimeZone;
    }
