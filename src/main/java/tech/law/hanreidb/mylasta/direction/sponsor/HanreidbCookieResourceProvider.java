 ...
 * @author jflute
 */
public class HanreidbCookieResourceProvider implements CookieResourceProvider {

    protected final HanreidbConfig config;
    protected final InvertibleCryptographer cookieCipher;

    public HanreidbCookieResourceProvider(HanreidbConfig config, InvertibleCryptographer cookieCipher) {
        this.config = config;
