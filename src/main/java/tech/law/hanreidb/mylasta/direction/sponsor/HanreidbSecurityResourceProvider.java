 ...
 * @author jflute
 */
public class HanreidbSecurityResourceProvider implements SecurityResourceProvider {
    ...
    public HanreidbSecurityResourceProvider(InvertibleCryptographer primaryInvertibleCryptographer,
