...
/**
 * The base condition-bean of CLS_SOURCE.
 * @author DBFlute(AutoGenerator)
 */
public class BsClsSourceCB extends AbstractConditionBean {

    // ===================================================================================
    //                                                                           Attribute
    //                                                                           =========
    protected ClsSourceCQ _conditionQuery;

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public BsClsSourceCB() {
    ...
    public ClsSourceCB acceptPK(String sourceCode) {
        ...
        BsClsSourceCB cb = this;
        cb.query().setSourceCode_Equal(sourceCode);
        return (ClsSourceCB)this;
    }
     ...
     * @return this. (NotNull)
     */
    public ClsSourceCB acceptUniqueOfDisplayOrder(Integer displayOrder) {
    ...
    public ClsSourceCB acceptUniqueOfSourceAlias(String sourceAlias) {
        ...
        BsClsSourceCB cb = this;
        cb.query().setSourceAlias_Equal(sourceAlias);
        return (ClsSourceCB)this;
    }
    ...
    public ClsSourceCB acceptUniqueOfSourceName(String sourceName) {
        ...
        BsClsSourceCB cb = this;
        cb.query().setSourceName_Equal(sourceName);
        return (ClsSourceCB)this;
    }

    public ConditionBean addOrderBy_PK_Asc() {
        query().addOrderBy_SourceCode_Asc();
        return this;
    }

    public ConditionBean addOrderBy_PK_Desc() {
        query().addOrderBy_SourceCode_Desc();
        return this;
    }
     ...
     */
    public ClsSourceCQ query() {
        assertQueryPurpose(); // assert only when user-public query 
        return doGetConditionQuery();
    }

    public ClsSourceCQ xdfgetConditionQuery() { // public for parameter comment and internal
        return doGetConditionQuery();
    }

    protected ClsSourceCQ doGetConditionQuery() {
    ...
    protected ClsSourceCQ createLocalCQ() {
        return xcreateCQ(null, getSqlClause(), getSqlClause().getBasePointAliasName(), 0);
    }

    protected ClsSourceCQ xcreateCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
        ClsSourceCQ cq = xnewCQ(childQuery, sqlClause, aliasName, nestLevel);
        cq.xsetBaseCB(this);
        return cq;
    }

    protected ClsSourceCQ xnewCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
        return new ClsSourceCQ(childQuery, sqlClause, aliasName, nestLevel);
    }
     ...
     */
    public void union(UnionQuery<ClsSourceCB> unionCBLambda) {
        final ClsSourceCB cb = new ClsSourceCB(); cb.xsetupForUnion(this); xsyncUQ(cb); 
        try { lock(); unionCBLambda.query(cb); } finally { unlock(); } xsaveUCB(cb);
        final ClsSourceCQ cq = cb.query(); query().xsetUnionQuery(cq);
    }
     ...
     */
    public void unionAll(UnionQuery<ClsSourceCB> unionCBLambda) {
        final ClsSourceCB cb = new ClsSourceCB(); cb.xsetupForUnion(this); xsyncUQ(cb);
        try { lock(); unionCBLambda.query(cb); } finally { unlock(); } xsaveUCB(cb);
        final ClsSourceCQ cq = cb.query(); query().xsetUnionAllQuery(cq);
    }
    ...
    public static class HpSpecification extends HpAbstractSpecification<ClsSourceCQ> {
        public HpSpecification(ConditionBean baseCB, HpSpQyCall<ClsSourceCQ> qyCall
        ...
        @Override
        protected String getTableDbName() { return "CLS_SOURCE"; }
        /**
         ...
         */
        public HpSDRFunction<JudgementSourceRelCB, ClsSourceCQ> derivedJudgementSourceRel() {
            assertDerived("judgementSourceRelList"); if (xhasSyncQyCall()) { xsyncQyCall().qy(); } // for sync (for example, this in ColumnQuery)
            return cHSDRF(_baseCB, _qyCall.qy(), (String fn, SubQuery<JudgementSourceRelCB> sq, ClsSourceCQ cq, String al, DerivedReferrerOption op)
         ...
         */
        public HpSDRFunction<ClsSourceCB, ClsSourceCQ> myselfDerived() {
            assertDerived("myselfDerived"); if (xhasSyncQyCall()) { xsyncQyCall().qy(); } // for sync (for example, this in ColumnQuery)
            return cHSDRF(_baseCB, _qyCall.qy(), (String fn, SubQuery<ClsSourceCB> sq, ClsSourceCQ cq, String al, DerivedReferrerOption op)
     ...
     */
    public ClsSourceCB dreamCruiseCB() {
        ClsSourceCB cb = new ClsSourceCB();
        cb.xsetupForDreamCruise((ClsSourceCB) this);
        return cb;
    }
     ...
     */
    public HpColQyOperand<ClsSourceCB> columnQuery(final SpecifyQuery<ClsSourceCB> colCBLambda) {
        return xcreateColQyOperand((rightSp, operand) -> {
            return xcolqy(xcreateColumnQueryCB(), xcreateColumnQueryCB(), colCBLambda, rightSp, operand);
        });
    }

    protected ClsSourceCB xcreateColumnQueryCB() {
        ClsSourceCB cb = new ClsSourceCB();
        cb.xsetupForColumnQuery((ClsSourceCB)this);
        return cb;
    }
     ...
     */
    public void orScopeQuery(OrQuery<ClsSourceCB> orCBLambda) {
        xorSQ((ClsSourceCB)this, orCBLambda);
    }
     ...
     */
    public void orScopeQueryAndPart(AndQuery<ClsSourceCB> andCBLambda) {
        xorSQAP((ClsSourceCB)this, andCBLambda);
    }
    ...
    protected void xprepareSyncQyCall(ConditionBean mainCB) {
        final ClsSourceCB cb;
        if (mainCB != null) {
            cb = (ClsSourceCB)mainCB;
        } else {
            cb = new ClsSourceCB();
        }
    ...
    protected String xgetConditionBeanClassNameInternally() { return ClsSourceCB.class.getName(); }
    protected String xgetConditionQueryClassNameInternally() { return ClsSourceCQ.class.getName(); }
