...
import tech.law.hanreidb.dbflute.cbean.cq.bs.BsClsCourtTypeCQ;

/**
 * The condition-query of CLS_COURT_TYPE.
 * <p>
 ...
 */
public class ClsCourtTypeCQ extends BsClsCourtTypeCQ {
     ...
     */
    public ClsCourtTypeCQ(ConditionQuery referrerQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
