...
import tech.law.hanreidb.dbflute.cbean.cq.bs.BsLawTocCQ;

/**
 * The condition-query of LAW_TOC.
 * <p>
 ...
 */
public class LawTocCQ extends BsLawTocCQ {
     ...
     */
    public LawTocCQ(ConditionQuery referrerQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
