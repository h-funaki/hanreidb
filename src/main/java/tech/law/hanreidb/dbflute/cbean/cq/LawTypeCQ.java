...
import tech.law.hanreidb.dbflute.cbean.cq.bs.BsLawTypeCQ;

/**
 * The condition-query of LAW_TYPE.
 * <p>
 ...
 */
public class LawTypeCQ extends BsLawTypeCQ {
     ...
     */
    public LawTypeCQ(ConditionQuery referrerQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
