...
import tech.law.hanreidb.dbflute.cbean.cq.bs.BsLawSourceRelCQ;

/**
 * The condition-query of LAW_SOURCE_REL.
 * <p>
 ...
 */
public class LawSourceRelCQ extends BsLawSourceRelCQ {
     ...
     */
    public LawSourceRelCQ(ConditionQuery referrerQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
