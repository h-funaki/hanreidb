...
import tech.law.hanreidb.dbflute.cbean.cq.bs.BsLawCQ;

/**
 * The condition-query of LAW.
 * <p>
 ...
 */
public class LawCQ extends BsLawCQ {
     ...
     */
    public LawCQ(ConditionQuery referrerQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
