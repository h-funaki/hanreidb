...
import tech.law.hanreidb.dbflute.cbean.cq.bs.BsSourceCQ;

/**
 * The condition-query of SOURCE.
 * <p>
 ...
 */
public class SourceCQ extends BsSourceCQ {
     ...
     */
    public SourceCQ(ConditionQuery referrerQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
