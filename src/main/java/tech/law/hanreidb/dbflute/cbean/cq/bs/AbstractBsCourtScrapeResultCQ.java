...
/**
 * The abstract condition-query of COURT_SCRAPE_RESULT.
 * @author DBFlute(AutoGenerator)
 */
public abstract class AbstractBsCourtScrapeResultCQ extends AbstractConditionQuery {

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public AbstractBsCourtScrapeResultCQ(ConditionQuery referrerQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
     ...
     * @param courtScrapeResultId The value of courtScrapeResultId as equal. (basically NotNull: error as default, or no condition as option)
     */
    public void setCourtScrapeResultId_Equal(Long courtScrapeResultId) {
        doSetCourtScrapeResultId_Equal(courtScrapeResultId);
    }

    protected void doSetCourtScrapeResultId_Equal(Long courtScrapeResultId) {
        regCourtScrapeResultId(CK_EQ, courtScrapeResultId);
    }

    /**
     * NotEqual(&lt;&gt;). And NullIgnored, OnlyOnceRegistered. <br>
     * (裁判所スクレイピング結果ID)COURT_SCRAPE_RESULT_ID: {PK, ID, NotNull, BIGINT UNSIGNED(20)}
     * @param courtScrapeResultId The value of courtScrapeResultId as notEqual. (basically NotNull: error as default, or no condition as option)
     */
    public void setCourtScrapeResultId_NotEqual(Long courtScrapeResultId) {
        doSetCourtScrapeResultId_NotEqual(courtScrapeResultId);
    }

    protected void doSetCourtScrapeResultId_NotEqual(Long courtScrapeResultId) {
        regCourtScrapeResultId(CK_NES, courtScrapeResultId);
    }

    /**
     * GreaterThan(&gt;). And NullIgnored, OnlyOnceRegistered. <br>
     * (裁判所スクレイピング結果ID)COURT_SCRAPE_RESULT_ID: {PK, ID, NotNull, BIGINT UNSIGNED(20)}
     * @param courtScrapeResultId The value of courtScrapeResultId as greaterThan. (basically NotNull: error as default, or no condition as option)
     */
    public void setCourtScrapeResultId_GreaterThan(Long courtScrapeResultId) {
        regCourtScrapeResultId(CK_GT, courtScrapeResultId);
    }

    /**
     * LessThan(&lt;). And NullIgnored, OnlyOnceRegistered. <br>
     * (裁判所スクレイピング結果ID)COURT_SCRAPE_RESULT_ID: {PK, ID, NotNull, BIGINT UNSIGNED(20)}
     * @param courtScrapeResultId The value of courtScrapeResultId as lessThan. (basically NotNull: error as default, or no condition as option)
     */
    public void setCourtScrapeResultId_LessThan(Long courtScrapeResultId) {
        regCourtScrapeResultId(CK_LT, courtScrapeResultId);
    }

    /**
     * GreaterEqual(&gt;=). And NullIgnored, OnlyOnceRegistered. <br>
     * (裁判所スクレイピング結果ID)COURT_SCRAPE_RESULT_ID: {PK, ID, NotNull, BIGINT UNSIGNED(20)}
     * @param courtScrapeResultId The value of courtScrapeResultId as greaterEqual. (basically NotNull: error as default, or no condition as option)
     */
    public void setCourtScrapeResultId_GreaterEqual(Long courtScrapeResultId) {
        regCourtScrapeResultId(CK_GE, courtScrapeResultId);
    }

    /**
     * LessEqual(&lt;=). And NullIgnored, OnlyOnceRegistered. <br>
     * (裁判所スクレイピング結果ID)COURT_SCRAPE_RESULT_ID: {PK, ID, NotNull, BIGINT UNSIGNED(20)}
     * @param courtScrapeResultId The value of courtScrapeResultId as lessEqual. (basically NotNull: error as default, or no condition as option)
     */
    public void setCourtScrapeResultId_LessEqual(Long courtScrapeResultId) {
        regCourtScrapeResultId(CK_LE, courtScrapeResultId);
    }
     ...
     * (裁判所スクレイピング結果ID)COURT_SCRAPE_RESULT_ID: {PK, ID, NotNull, BIGINT UNSIGNED(20)}
     * @param minNumber The min number of courtScrapeResultId. (NullAllowed: if null, no from-condition)
     * @param maxNumber The max number of courtScrapeResultId. (NullAllowed: if null, no to-condition)
     * @param opLambda The callback for option of range-of. (NotNull)
     */
    public void setCourtScrapeResultId_RangeOf(Long minNumber, Long maxNumber, ConditionOptionCall<RangeOfOption> opLambda) {
        setCourtScrapeResultId_RangeOf(minNumber, maxNumber, xcROOP(opLambda));
    }
     ...
     */
    protected void setCourtScrapeResultId_RangeOf(Long minNumber, Long maxNumber, RangeOfOption rangeOfOption) {
        regROO(minNumber, maxNumber, xgetCValueCourtScrapeResultId(), "COURT_SCRAPE_RESULT_ID", rangeOfOption);
    }

    /**
     * InScope {in (1, 2)}. And NullIgnored, NullElementIgnored, SeveralRegistered. <br>
     * (裁判所スクレイピング結果ID)COURT_SCRAPE_RESULT_ID: {PK, ID, NotNull, BIGINT UNSIGNED(20)}
     * @param courtScrapeResultIdList The collection of courtScrapeResultId as inScope. (NullAllowed: if null (or empty), no condition)
     */
    public void setCourtScrapeResultId_InScope(Collection<Long> courtScrapeResultIdList) {
        doSetCourtScrapeResultId_InScope(courtScrapeResultIdList);
    }

    protected void doSetCourtScrapeResultId_InScope(Collection<Long> courtScrapeResultIdList) {
        regINS(CK_INS, cTL(courtScrapeResultIdList), xgetCValueCourtScrapeResultId(), "COURT_SCRAPE_RESULT_ID");
    }

    /**
     * NotInScope {not in (1, 2)}. And NullIgnored, NullElementIgnored, SeveralRegistered. <br>
     * (裁判所スクレイピング結果ID)COURT_SCRAPE_RESULT_ID: {PK, ID, NotNull, BIGINT UNSIGNED(20)}
     * @param courtScrapeResultIdList The collection of courtScrapeResultId as notInScope. (NullAllowed: if null (or empty), no condition)
     */
    public void setCourtScrapeResultId_NotInScope(Collection<Long> courtScrapeResultIdList) {
        doSetCourtScrapeResultId_NotInScope(courtScrapeResultIdList);
    }

    protected void doSetCourtScrapeResultId_NotInScope(Collection<Long> courtScrapeResultIdList) {
        regINS(CK_NINS, cTL(courtScrapeResultIdList), xgetCValueCourtScrapeResultId(), "COURT_SCRAPE_RESULT_ID");
    }
     ...
     * (裁判所スクレイピング結果ID)COURT_SCRAPE_RESULT_ID: {PK, ID, NotNull, BIGINT UNSIGNED(20)}
     */
    public void setCourtScrapeResultId_IsNull() { regCourtScrapeResultId(CK_ISN, DOBJ); }

    /**
     * IsNotNull {is not null}. And OnlyOnceRegistered. <br>
     * (裁判所スクレイピング結果ID)COURT_SCRAPE_RESULT_ID: {PK, ID, NotNull, BIGINT UNSIGNED(20)}
     */
    public void setCourtScrapeResultId_IsNotNull() { regCourtScrapeResultId(CK_ISNN, DOBJ); }

    protected void regCourtScrapeResultId(ConditionKey ky, Object vl) { regQ(ky, vl, xgetCValueCourtScrapeResultId(), "COURT_SCRAPE_RESULT_ID"); }
    protected abstract ConditionValue xgetCValueCourtScrapeResultId();
     ...
     */
    public HpSLCFunction<CourtScrapeResultCB> scalar_Equal() {
        return xcreateSLCFunction(CK_EQ, CourtScrapeResultCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<CourtScrapeResultCB> scalar_NotEqual() {
        return xcreateSLCFunction(CK_NES, CourtScrapeResultCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<CourtScrapeResultCB> scalar_GreaterThan() {
        return xcreateSLCFunction(CK_GT, CourtScrapeResultCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<CourtScrapeResultCB> scalar_LessThan() {
        return xcreateSLCFunction(CK_LT, CourtScrapeResultCB.class);
    }
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<CourtScrapeResultCB> scalar_GreaterEqual() {
        return xcreateSLCFunction(CK_GE, CourtScrapeResultCB.class);
    }
     ...
     * {where FOO &lt;= (select max(BAR) from ...)}
     * <pre>
     * cb.query().<span style="color: #CC4747">scalar_LessEqual()</span>.max(new SubQuery&lt;CourtScrapeResultCB&gt;() {
     *     public void query(CourtScrapeResultCB subCB) {
     ...
     * @return The object to set up a function. (NotNull)
     */
    public HpSLCFunction<CourtScrapeResultCB> scalar_LessEqual() {
        return xcreateSLCFunction(CK_LE, CourtScrapeResultCB.class);
    }

    @SuppressWarnings("unchecked")
    protected <CB extends ConditionBean> void xscalarCondition(String fn, SubQuery<CB> sq, String rd, HpSLCCustomized<CB> cs, ScalarConditionOption op) {
        assertObjectNotNull("subQuery", sq);
        CourtScrapeResultCB cb = xcreateScalarConditionCB(); sq.query((CB)cb);
        String pp = keepScalarCondition(cb.query()); // for saving query-value
        cs.setPartitionByCBean((CB)xcreateScalarConditionPartitionByCB()); // for using partition-by
        registerScalarCondition(fn, cb.query(), pp, rd, cs, op);
    }
    public abstract String keepScalarCondition(CourtScrapeResultCQ sq);

    protected CourtScrapeResultCB xcreateScalarConditionCB() {
        CourtScrapeResultCB cb = newMyCB(); cb.xsetupForScalarCondition(this); return cb;
    }

    protected CourtScrapeResultCB xcreateScalarConditionPartitionByCB() {
        CourtScrapeResultCB cb = newMyCB(); cb.xsetupForScalarConditionPartitionBy(this); return cb;
    }

    // ===================================================================================
    //                                                                       MyselfDerived
    //                                                                       =============
    public void xsmyselfDerive(String fn, SubQuery<CourtScrapeResultCB> sq, String al, DerivedReferrerOption op) {
        assertObjectNotNull("subQuery", sq);
        CourtScrapeResultCB cb = new CourtScrapeResultCB(); cb.xsetupForDerivedReferrer(this);
        lockCall(() -> sq.query(cb)); String pp = keepSpecifyMyselfDerived(cb.query()); String pk = "COURT_SCRAPE_RESULT_ID";
        registerSpecifyMyselfDerived(fn, cb.query(), pk, pk, pp, "myselfDerived", al, op);
    }
    public abstract String keepSpecifyMyselfDerived(CourtScrapeResultCQ sq);

    /**
     * Prepare for (Query)MyselfDerived (correlated sub-query).
     * @return The object to set up a function for myself table. (NotNull)
     */
    public HpQDRFunction<CourtScrapeResultCB> myselfDerived() {
        return xcreateQDRFunctionMyselfDerived(CourtScrapeResultCB.class);
    }
    @SuppressWarnings("unchecked")
    protected <CB extends ConditionBean> void xqderiveMyselfDerived(String fn, SubQuery<CB> sq, String rd, Object vl, DerivedReferrerOption op) {
        assertObjectNotNull("subQuery", sq);
        CourtScrapeResultCB cb = new CourtScrapeResultCB(); cb.xsetupForDerivedReferrer(this); sq.query((CB)cb);
        String pk = "COURT_SCRAPE_RESULT_ID";
        String sqpp = keepQueryMyselfDerived(cb.query()); // for saving query-value.
        String prpp = keepQueryMyselfDerivedParameter(vl);
        registerQueryMyselfDerived(fn, cb.query(), pk, pk, sqpp, "myselfDerived", rd, vl, prpp, op);
    }
    public abstract String keepQueryMyselfDerived(CourtScrapeResultCQ sq);
     ...
     */
    public void myselfExists(SubQuery<CourtScrapeResultCB> subCBLambda) {
        assertObjectNotNull("subCBLambda", subCBLambda);
        CourtScrapeResultCB cb = new CourtScrapeResultCB(); cb.xsetupForMyselfExists(this);
        lockCall(() -> subCBLambda.query(cb)); String pp = keepMyselfExists(cb.query());
        registerMyselfExists(cb.query(), pp);
    }
    public abstract String keepMyselfExists(CourtScrapeResultCQ sq);
    ...
    //                                                                       Very Internal
    //                                                                       =============
    protected CourtScrapeResultCB newMyCB() {
        return new CourtScrapeResultCB();
    }
    // very internal (for suppressing warn about 'Not Use Import')
    protected String xabUDT() { return Date.class.getName(); }
    protected String xabCQ() { return CourtScrapeResultCQ.class.getName(); }
