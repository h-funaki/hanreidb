...
import tech.law.hanreidb.dbflute.cbean.cq.UserStatusHistoryCQ;

/**
 * The nest select set-upper of USER_STATUS_HISTORY.
 * @author DBFlute(AutoGenerator)
 */
public class UserStatusHistoryNss {

    // ===================================================================================
    //                                                                           Attribute
    //                                                                           =========
    protected final UserStatusHistoryCQ _query;
    public UserStatusHistoryNss(UserStatusHistoryCQ query) { _query = query; }
