...
import tech.law.hanreidb.dbflute.cbean.cq.bs.BsJudgementSourceRelCQ;

/**
 * The condition-query of JUDGEMENT_SOURCE_REL.
 * <p>
 ...
 */
public class JudgementSourceRelCQ extends BsJudgementSourceRelCQ {
     ...
     */
    public JudgementSourceRelCQ(ConditionQuery referrerQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
