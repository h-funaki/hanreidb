...
import tech.law.hanreidb.dbflute.cbean.cq.bs.BsClsEraCQ;

/**
 * The condition-query of CLS_ERA.
 * <p>
 ...
 */
public class ClsEraCQ extends BsClsEraCQ {
     ...
     */
    public ClsEraCQ(ConditionQuery referrerQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
