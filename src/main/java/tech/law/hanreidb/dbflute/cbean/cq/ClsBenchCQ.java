...
import tech.law.hanreidb.dbflute.cbean.cq.bs.BsClsBenchCQ;

/**
 * The condition-query of CLS_BENCH.
 * <p>
 ...
 */
public class ClsBenchCQ extends BsClsBenchCQ {
     ...
     */
    public ClsBenchCQ(ConditionQuery referrerQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
