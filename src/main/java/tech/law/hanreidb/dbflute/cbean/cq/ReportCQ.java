...
import tech.law.hanreidb.dbflute.cbean.cq.bs.BsReportCQ;

/**
 * The condition-query of REPORT.
 * <p>
 ...
 */
public class ReportCQ extends BsReportCQ {
     ...
     */
    public ReportCQ(ConditionQuery referrerQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
