...
import tech.law.hanreidb.dbflute.cbean.cq.bs.BsSourceLawCategoryCQ;

/**
 * The condition-query of SOURCE_LAW_CATEGORY.
 * <p>
 ...
 */
public class SourceLawCategoryCQ extends BsSourceLawCategoryCQ {
     ...
     */
    public SourceLawCategoryCQ(ConditionQuery referrerQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
