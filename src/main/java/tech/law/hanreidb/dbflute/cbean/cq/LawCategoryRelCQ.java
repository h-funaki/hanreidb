...
import tech.law.hanreidb.dbflute.cbean.cq.bs.BsLawCategoryRelCQ;

/**
 * The condition-query of LAW_CATEGORY_REL.
 * <p>
 ...
 */
public class LawCategoryRelCQ extends BsLawCategoryRelCQ {
     ...
     */
    public LawCategoryRelCQ(ConditionQuery referrerQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
