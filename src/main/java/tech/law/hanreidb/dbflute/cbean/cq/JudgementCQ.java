...
import tech.law.hanreidb.dbflute.cbean.cq.bs.BsJudgementCQ;

/**
 * The condition-query of JUDGEMENT.
 * <p>
 ...
 */
public class JudgementCQ extends BsJudgementCQ {
     ...
     */
    public JudgementCQ(ConditionQuery referrerQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
