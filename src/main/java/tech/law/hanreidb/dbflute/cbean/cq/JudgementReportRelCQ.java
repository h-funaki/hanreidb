...
import tech.law.hanreidb.dbflute.cbean.cq.bs.BsJudgementReportRelCQ;

/**
 * The condition-query of JUDGEMENT_REPORT_REL.
 * <p>
 ...
 */
public class JudgementReportRelCQ extends BsJudgementReportRelCQ {
     ...
     */
    public JudgementReportRelCQ(ConditionQuery referrerQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
