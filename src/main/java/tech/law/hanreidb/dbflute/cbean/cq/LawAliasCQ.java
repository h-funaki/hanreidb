...
import tech.law.hanreidb.dbflute.cbean.cq.bs.BsLawAliasCQ;

/**
 * The condition-query of LAW_ALIAS.
 * <p>
 ...
 */
public class LawAliasCQ extends BsLawAliasCQ {
     ...
     */
    public LawAliasCQ(ConditionQuery referrerQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
