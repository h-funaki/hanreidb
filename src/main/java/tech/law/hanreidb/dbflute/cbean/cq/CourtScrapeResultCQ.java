...
import tech.law.hanreidb.dbflute.cbean.cq.bs.BsCourtScrapeResultCQ;

/**
 * The condition-query of COURT_SCRAPE_RESULT.
 * <p>
 ...
 */
public class CourtScrapeResultCQ extends BsCourtScrapeResultCQ {
     ...
     */
    public CourtScrapeResultCQ(ConditionQuery referrerQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
