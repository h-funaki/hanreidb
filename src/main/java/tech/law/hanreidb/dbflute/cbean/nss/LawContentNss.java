...
import tech.law.hanreidb.dbflute.cbean.cq.LawContentCQ;

/**
 * The nest select set-upper of LAW_CONTENT.
 * @author DBFlute(AutoGenerator)
 */
public class LawContentNss {

    // ===================================================================================
    //                                                                           Attribute
    //                                                                           =========
    protected final LawContentCQ _query;
    public LawContentNss(LawContentCQ query) { _query = query; }
