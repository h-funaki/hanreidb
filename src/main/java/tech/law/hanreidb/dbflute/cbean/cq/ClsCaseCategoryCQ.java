...
import tech.law.hanreidb.dbflute.cbean.cq.bs.BsClsCaseCategoryCQ;

/**
 * The condition-query of CLS_CASE_CATEGORY.
 * <p>
 ...
 */
public class ClsCaseCategoryCQ extends BsClsCaseCategoryCQ {
     ...
     */
    public ClsCaseCategoryCQ(ConditionQuery referrerQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
