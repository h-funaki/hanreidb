...
import tech.law.hanreidb.dbflute.cbean.cq.bs.BsCourtCQ;

/**
 * The condition-query of COURT.
 * <p>
 ...
 */
public class CourtCQ extends BsCourtCQ {
     ...
     */
    public CourtCQ(ConditionQuery referrerQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
