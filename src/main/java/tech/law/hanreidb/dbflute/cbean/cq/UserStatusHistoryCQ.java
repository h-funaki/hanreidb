...
import tech.law.hanreidb.dbflute.cbean.cq.bs.BsUserStatusHistoryCQ;

/**
 * The condition-query of USER_STATUS_HISTORY.
 * <p>
 ...
 */
public class UserStatusHistoryCQ extends BsUserStatusHistoryCQ {
     ...
     */
    public UserStatusHistoryCQ(ConditionQuery referrerQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
