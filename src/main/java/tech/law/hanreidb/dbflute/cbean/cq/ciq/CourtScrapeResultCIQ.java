...
/**
 * The condition-query for in-line of COURT_SCRAPE_RESULT.
 * @author DBFlute(AutoGenerator)
 */
public class CourtScrapeResultCIQ extends AbstractBsCourtScrapeResultCQ {

    // ===================================================================================
    //                                                                           Attribute
    //                                                                           =========
    protected BsCourtScrapeResultCQ _myCQ;

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public CourtScrapeResultCIQ(ConditionQuery referrerQuery, SqlClause sqlClause
                        , String aliasName, int nestLevel, BsCourtScrapeResultCQ myCQ) {
    ...
    //                                                                ====================
    protected ConditionValue xgetCValueCourtScrapeResultId() { return _myCQ.xdfgetCourtScrapeResultId(); }
    ...
    public String keepScalarCondition(CourtScrapeResultCQ sq)
    { throwIICBOE("ScalarCondition"); return null; }
    public String keepSpecifyMyselfDerived(CourtScrapeResultCQ sq)
    { throwIICBOE("(Specify)MyselfDerived"); return null;}
    public String keepQueryMyselfDerived(CourtScrapeResultCQ sq)
    { throwIICBOE("(Query)MyselfDerived"); return null;}
    public String keepQueryMyselfDerivedParameter(Object vl)
    { throwIICBOE("(Query)MyselfDerived"); return null;}
    public String keepMyselfExists(CourtScrapeResultCQ sq)
    ...
    protected String xinCB() { return CourtScrapeResultCB.class.getName(); }
    protected String xinCQ() { return CourtScrapeResultCQ.class.getName(); }
}
