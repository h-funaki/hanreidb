...
/**
 * The condition-query for in-line of CLS_SOURCE.
 * @author DBFlute(AutoGenerator)
 */
public class ClsSourceCIQ extends AbstractBsClsSourceCQ {

    // ===================================================================================
    //                                                                           Attribute
    //                                                                           =========
    protected BsClsSourceCQ _myCQ;

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public ClsSourceCIQ(ConditionQuery referrerQuery, SqlClause sqlClause
                        , String aliasName, int nestLevel, BsClsSourceCQ myCQ) {
    ...
    public String keepScalarCondition(ClsSourceCQ sq)
    { throwIICBOE("ScalarCondition"); return null; }
    public String keepSpecifyMyselfDerived(ClsSourceCQ sq)
    { throwIICBOE("(Specify)MyselfDerived"); return null;}
    public String keepQueryMyselfDerived(ClsSourceCQ sq)
    { throwIICBOE("(Query)MyselfDerived"); return null;}
    public String keepQueryMyselfDerivedParameter(Object vl)
    { throwIICBOE("(Query)MyselfDerived"); return null;}
    public String keepMyselfExists(ClsSourceCQ sq)
    ...
    protected String xinCB() { return ClsSourceCB.class.getName(); }
    protected String xinCQ() { return ClsSourceCQ.class.getName(); }
}
