...
import tech.law.hanreidb.dbflute.cbean.cq.bs.BsCaseMarkCQ;

/**
 * The condition-query of CASE_MARK.
 * <p>
 ...
 */
public class CaseMarkCQ extends BsCaseMarkCQ {
     ...
     */
    public CaseMarkCQ(ConditionQuery referrerQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
