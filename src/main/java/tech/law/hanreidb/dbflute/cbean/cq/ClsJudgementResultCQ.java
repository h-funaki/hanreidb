...
import tech.law.hanreidb.dbflute.cbean.cq.bs.BsClsJudgementResultCQ;

/**
 * The condition-query of CLS_JUDGEMENT_RESULT.
 * <p>
 ...
 */
public class ClsJudgementResultCQ extends BsClsJudgementResultCQ {
     ...
     */
    public ClsJudgementResultCQ(ConditionQuery referrerQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
