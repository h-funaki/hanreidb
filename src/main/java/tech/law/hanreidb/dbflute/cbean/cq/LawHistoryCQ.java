...
import tech.law.hanreidb.dbflute.cbean.cq.bs.BsLawHistoryCQ;

/**
 * The condition-query of LAW_HISTORY.
 * <p>
 ...
 */
public class LawHistoryCQ extends BsLawHistoryCQ {
     ...
     */
    public LawHistoryCQ(ConditionQuery referrerQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
