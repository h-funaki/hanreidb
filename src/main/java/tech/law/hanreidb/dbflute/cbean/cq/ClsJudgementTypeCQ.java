...
import tech.law.hanreidb.dbflute.cbean.cq.bs.BsClsJudgementTypeCQ;

/**
 * The condition-query of CLS_JUDGEMENT_TYPE.
 * <p>
 ...
 */
public class ClsJudgementTypeCQ extends BsClsJudgementTypeCQ {
     ...
     */
    public ClsJudgementTypeCQ(ConditionQuery referrerQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
