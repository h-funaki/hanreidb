...
import tech.law.hanreidb.dbflute.cbean.cq.bs.BsCourtJudgementCQ;

/**
 * The condition-query of COURT_JUDGEMENT.
 * <p>
 ...
 */
public class CourtJudgementCQ extends BsCourtJudgementCQ {
     ...
     */
    public CourtJudgementCQ(ConditionQuery referrerQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
