...
import tech.law.hanreidb.dbflute.cbean.cq.bs.BsArticleCQ;

/**
 * The condition-query of ARTICLE.
 * <p>
 ...
 */
public class ArticleCQ extends BsArticleCQ {
     ...
     */
    public ArticleCQ(ConditionQuery referrerQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
