...
/**
 * The base condition-bean of CLS_USER_STATUS.
 * @author DBFlute(AutoGenerator)
 */
public class BsClsUserStatusCB extends AbstractConditionBean {

    // ===================================================================================
    //                                                                           Attribute
    //                                                                           =========
    protected ClsUserStatusCQ _conditionQuery;

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public BsClsUserStatusCB() {
    ...
    public ClsUserStatusCB acceptPK(String userStatusCode) {
        ...
        cb.query().setUserStatusCode_Equal(userStatusCode);
    ...
    public ConditionBean addOrderBy_PK_Desc() {
        query().addOrderBy_UserStatusCode_Desc();
        return this;
    }
     ...
     */
    public ClsUserStatusCQ query() {
        assertQueryPurpose(); // assert only when user-public query 
        return doGetConditionQuery();
    }

    public ClsUserStatusCQ xdfgetConditionQuery() { // public for parameter comment and internal
        return doGetConditionQuery();
    }

    protected ClsUserStatusCQ doGetConditionQuery() {
    ...
    protected ClsUserStatusCQ createLocalCQ() {
        return xcreateCQ(null, getSqlClause(), getSqlClause().getBasePointAliasName(), 0);
    }

    protected ClsUserStatusCQ xcreateCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
        ClsUserStatusCQ cq = xnewCQ(childQuery, sqlClause, aliasName, nestLevel);
        cq.xsetBaseCB(this);
        return cq;
    }

    protected ClsUserStatusCQ xnewCQ(ConditionQuery childQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
        return new ClsUserStatusCQ(childQuery, sqlClause, aliasName, nestLevel);
    }
     ...
     */
    public void union(UnionQuery<ClsUserStatusCB> unionCBLambda) {
        final ClsUserStatusCB cb = new ClsUserStatusCB(); cb.xsetupForUnion(this); xsyncUQ(cb); 
        try { lock(); unionCBLambda.query(cb); } finally { unlock(); } xsaveUCB(cb);
        final ClsUserStatusCQ cq = cb.query(); query().xsetUnionQuery(cq);
    }
     ...
     */
    public void unionAll(UnionQuery<ClsUserStatusCB> unionCBLambda) {
        final ClsUserStatusCB cb = new ClsUserStatusCB(); cb.xsetupForUnion(this); xsyncUQ(cb);
        try { lock(); unionCBLambda.query(cb); } finally { unlock(); } xsaveUCB(cb);
        final ClsUserStatusCQ cq = cb.query(); query().xsetUnionAllQuery(cq);
    }
    ...
    public static class HpSpecification extends HpAbstractSpecification<ClsUserStatusCQ> {
        public HpSpecification(ConditionBean baseCB, HpSpQyCall<ClsUserStatusCQ> qyCall
        ...
        protected void doSpecifyRequiredColumn() {
            columnUserStatusCode(); // PK
        }
        @Override
        protected String getTableDbName() { return "CLS_USER_STATUS"; }
        /**
         * Prepare for (Specify)DerivedReferrer (correlated sub-query). <br>
         * {select max(FOO) from USER where ...) as FOO_MAX} <br>
         ...
         * }, User.<span style="color: #CC4747">ALIAS_foo...</span>);
         * </pre>
         * @return The object to set up a function for referrer table. (NotNull)
         */
        public HpSDRFunction<UserCB, ClsUserStatusCQ> derivedUser() {
         ...
         */
        public HpSDRFunction<ClsUserStatusCB, ClsUserStatusCQ> myselfDerived() {
            assertDerived("myselfDerived"); if (xhasSyncQyCall()) { xsyncQyCall().qy(); } // for sync (for example, this in ColumnQuery)
            return cHSDRF(_baseCB, _qyCall.qy(), (String fn, SubQuery<ClsUserStatusCB> sq, ClsUserStatusCQ cq, String al, DerivedReferrerOption op)
     ...
     */
    public ClsUserStatusCB dreamCruiseCB() {
        ClsUserStatusCB cb = new ClsUserStatusCB();
        cb.xsetupForDreamCruise((ClsUserStatusCB) this);
        return cb;
    }
     ...
     */
    public HpColQyOperand<ClsUserStatusCB> columnQuery(final SpecifyQuery<ClsUserStatusCB> colCBLambda) {
        return xcreateColQyOperand((rightSp, operand) -> {
            return xcolqy(xcreateColumnQueryCB(), xcreateColumnQueryCB(), colCBLambda, rightSp, operand);
        });
    }

    protected ClsUserStatusCB xcreateColumnQueryCB() {
        ClsUserStatusCB cb = new ClsUserStatusCB();
        cb.xsetupForColumnQuery((ClsUserStatusCB)this);
        return cb;
    }
     ...
     */
    public void orScopeQuery(OrQuery<ClsUserStatusCB> orCBLambda) {
        xorSQ((ClsUserStatusCB)this, orCBLambda);
    }
     ...
     */
    public void orScopeQueryAndPart(AndQuery<ClsUserStatusCB> andCBLambda) {
        xorSQAP((ClsUserStatusCB)this, andCBLambda);
    }
    ...
    protected void xprepareSyncQyCall(ConditionBean mainCB) {
        final ClsUserStatusCB cb;
        if (mainCB != null) {
            cb = (ClsUserStatusCB)mainCB;
        } else {
            cb = new ClsUserStatusCB();
        }
    ...
    protected String xgetConditionBeanClassNameInternally() { return ClsUserStatusCB.class.getName(); }
    protected String xgetConditionQueryClassNameInternally() { return ClsUserStatusCQ.class.getName(); }
