...
import tech.law.hanreidb.dbflute.cbean.cq.bs.BsLoginHistoryCQ;

/**
 * The condition-query of LOGIN_HISTORY.
 * <p>
 ...
 */
public class LoginHistoryCQ extends BsLoginHistoryCQ {
     ...
     */
    public LoginHistoryCQ(ConditionQuery referrerQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
