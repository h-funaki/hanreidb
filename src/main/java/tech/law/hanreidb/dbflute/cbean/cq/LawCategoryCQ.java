...
import tech.law.hanreidb.dbflute.cbean.cq.bs.BsLawCategoryCQ;

/**
 * The condition-query of LAW_CATEGORY.
 * <p>
 ...
 */
public class LawCategoryCQ extends BsLawCategoryCQ {
     ...
     */
    public LawCategoryCQ(ConditionQuery referrerQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
