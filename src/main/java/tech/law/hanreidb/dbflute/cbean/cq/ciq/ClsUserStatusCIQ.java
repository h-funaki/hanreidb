...
/**
 * The condition-query for in-line of CLS_USER_STATUS.
 * @author DBFlute(AutoGenerator)
 */
public class ClsUserStatusCIQ extends AbstractBsClsUserStatusCQ {

    // ===================================================================================
    //                                                                           Attribute
    //                                                                           =========
    protected BsClsUserStatusCQ _myCQ;

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public ClsUserStatusCIQ(ConditionQuery referrerQuery, SqlClause sqlClause
                        , String aliasName, int nestLevel, BsClsUserStatusCQ myCQ) {
    ...
    public String keepSpecifyMyselfDerived(ClsUserStatusCQ sq)
    { throwIICBOE("(Specify)MyselfDerived"); return null;}
    public String keepQueryMyselfDerived(ClsUserStatusCQ sq)
    { throwIICBOE("(Query)MyselfDerived"); return null;}
    public String keepQueryMyselfDerivedParameter(Object vl)
    { throwIICBOE("(Query)MyselfDerived"); return null;}
    public String keepMyselfExists(ClsUserStatusCQ sq)
    ...
    protected String xinCB() { return ClsUserStatusCB.class.getName(); }
    protected String xinCQ() { return ClsUserStatusCQ.class.getName(); }
}
