...
import tech.law.hanreidb.dbflute.cbean.cq.bs.BsArticleContentCQ;

/**
 * The condition-query of ARTICLE_CONTENT.
 * <p>
 ...
 */
public class ArticleContentCQ extends BsArticleContentCQ {
     ...
     */
    public ArticleContentCQ(ConditionQuery referrerQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
