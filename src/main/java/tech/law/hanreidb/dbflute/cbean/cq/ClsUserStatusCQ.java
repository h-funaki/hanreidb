...
import tech.law.hanreidb.dbflute.cbean.cq.bs.BsClsUserStatusCQ;

/**
 * The condition-query of CLS_USER_STATUS.
 * <p>
 ...
 */
public class ClsUserStatusCQ extends BsClsUserStatusCQ {
     ...
     */
    public ClsUserStatusCQ(ConditionQuery referrerQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
