...
import tech.law.hanreidb.dbflute.cbean.cq.bs.BsClsSourceCQ;

/**
 * The condition-query of CLS_SOURCE.
 * <p>
 ...
 */
public class ClsSourceCQ extends BsClsSourceCQ {
     ...
     */
    public ClsSourceCQ(ConditionQuery referrerQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
