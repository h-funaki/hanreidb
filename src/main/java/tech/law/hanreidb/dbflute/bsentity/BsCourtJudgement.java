...
/**
 * The entity of (裁判所判決)COURT_JUDGEMENT as TABLE. <br>
 * 裁判所からスクレイピングした結果を格納
 * <pre>
 * [primary-key]
 *     COURT_JUDGEMENT_ID
 ...
 * [get/set template]
 * /= = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = =
 * Long courtJudgementId = entity.getCourtJudgementId();
 ...
 * entity.setCourtJudgementId(courtJudgementId);
 ...
 */
public abstract class BsCourtJudgement extends AbstractEntity implements DomainEntity, EntityDefinedCommonColumn {
    ...
    public boolean hasPrimaryKeyValue() {
        if (_courtJudgementId == null) { return false; }
        return true;
    }
    ...
    protected boolean doEquals(Object obj) {
        if (obj instanceof BsCourtJudgement) {
            BsCourtJudgement other = (BsCourtJudgement)obj;
            if (!xSV(_courtJudgementId, other._courtJudgementId)) { return false; }
            return true;
        } else {
            return false;
        }
    ...
    protected String doBuildColumnString(String dm) {
        ...
        sb.append(dm).append(xfND(_courtJudgementId));
    ...
    @Override
    public CourtJudgement clone() {
        return (CourtJudgement)super.clone();
    }
    ...
    //                                                                            ========
    /**
     * [get] (裁判所判決ID)COURT_JUDGEMENT_ID: {PK, ID, NotNull, BIGINT UNSIGNED(20)} <br>
     * @return The value of the column 'COURT_JUDGEMENT_ID'. (basically NotNull if selected: for the constraint)
     */
    public Long getCourtJudgementId() {
        checkSpecifiedProperty("courtJudgementId");
        return _courtJudgementId;
    }

    /**
     * [set] (裁判所判決ID)COURT_JUDGEMENT_ID: {PK, ID, NotNull, BIGINT UNSIGNED(20)} <br>
     * @param courtJudgementId The value of the column 'COURT_JUDGEMENT_ID'. (basically NotNull if update: for the constraint)
     */
    public void setCourtJudgementId(Long courtJudgementId) {
        registerModifiedProperty("courtJudgementId");
        _courtJudgementId = courtJudgementId;
    }
