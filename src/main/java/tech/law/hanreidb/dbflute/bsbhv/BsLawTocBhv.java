...
public abstract class BsLawTocBhv extends AbstractBehaviorWritable<LawToc, LawTocCB> {
     ...
     * </pre>
     * @param lawToc The entity of update. (NotNull, PrimaryKeyNotNull, ConcurrencyColumnNotNull)
     ...
     * <span style="color: #0000C0">lawTocBhv</span>.<span style="color: #CC4747">updateNonstrict</span>(lawToc);
     * </pre>
     ...
     * @throws EntityAlreadyExistsException When the entity already exists. (unique constraint violation)
     */
    public void updateNonstrict(LawToc lawToc) {
        doUpdateNonstrict(lawToc, null);
    }
     ...
     * @throws EntityAlreadyExistsException When the entity already exists. (unique constraint violation)
     */
    public void insertOrUpdateNonstrict(LawToc lawToc) {
        doInsertOrUpdateNonstrict(lawToc, null, null);
    }
     ...
     * <span style="color: #3F7E5E">// (auto-increment for version number is valid though non-exclusive control)</span>
     * <span style="color: #3F7E5E">//lawToc.setVersionNo(value);</span>
     * <span style="color: #0000C0">lawTocBhv</span>.<span style="color: #CC4747">deleteNonstrict</span>(lawToc);
     * </pre>
     * @param lawToc The entity of delete. (NotNull, PrimaryKeyNotNull)
     * @throws EntityAlreadyDeletedException When the entity has already been deleted. (not found)
     * @throws EntityDuplicatedException When the entity has been duplicated.
     */
    public void deleteNonstrict(LawToc lawToc) {
        doDeleteNonstrict(lawToc, null);
    }
     ...
     * </pre>
     * @param lawTocList The list of the entity. (NotNull, EmptyAllowed, PrimaryKeyNotNull, ConcurrencyColumnNotNull)
     ...
     * @throws EntityAlreadyDeletedException When the entity has already been deleted. (not found)
     */
    public int[] batchUpdateNonstrict(List<LawToc> lawTocList) {
        return doBatchUpdateNonstrict(lawTocList, null);
    }
     ...
     * @throws EntityAlreadyDeletedException When the entity has already been deleted. (not found)
     */
    public int[] batchDeleteNonstrict(List<LawToc> lawTocList) {
        return doBatchDeleteNonstrict(lawTocList, null);
    }
     ...
     * <span style="color: #3F7E5E">// (auto-increment for version number is valid though non-exclusive control)</span>
     * <span style="color: #3F7E5E">//lawToc.setVersionNo(value);</span>
     * <span style="color: #0000C0">lawTocBhv</span>.<span style="color: #CC4747">varyingUpdateNonstrict</span>(lawToc, <span style="color: #553000">op</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">op</span>.self(<span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *         <span style="color: #553000">cb</span>.specify().<span style="color: #CC4747">columnXxxCount()</span>;
     *     }).plus(1); <span style="color: #3F7E5E">// XXX_COUNT = XXX_COUNT + 1</span>
     * });
     ...
     * @throws EntityAlreadyExistsException When the entity already exists. (unique constraint violation)
     */
    public void varyingUpdateNonstrict(LawToc lawToc, WritableOptionCall<LawTocCB, UpdateOption<LawTocCB>> opLambda) {
        doUpdateNonstrict(lawToc, createUpdateOption(opLambda));
    }
     ...
     * @throws EntityAlreadyExistsException When the entity already exists. (unique constraint violation)
     */
    public void varyingInsertOrUpdateNonstrict(LawToc lawToc, WritableOptionCall<LawTocCB, InsertOption<LawTocCB>> insertOpLambda, WritableOptionCall<LawTocCB, UpdateOption<LawTocCB>> updateOpLambda) {
        doInsertOrUpdateNonstrict(lawToc, createInsertOption(insertOpLambda), createUpdateOption(updateOpLambda));
    }
     ...
     * @throws EntityDuplicatedException When the entity has been duplicated.
     */
    public void varyingDeleteNonstrict(LawToc lawToc, WritableOptionCall<LawTocCB, DeleteOption<LawTocCB>> opLambda) {
        doDeleteNonstrict(lawToc, createDeleteOption(opLambda));
    }
     ...
     * @return The array of updated count. (NotNull, EmptyAllowed)
     */
    public int[] varyingBatchUpdateNonstrict(List<LawToc> lawTocList, WritableOptionCall<LawTocCB, UpdateOption<LawTocCB>> opLambda) {
        return doBatchUpdateNonstrict(lawTocList, createUpdateOption(opLambda));
    }
     ...
     * @return The array of deleted count. (NotNull, EmptyAllowed)
     */
    public int[] varyingBatchDeleteNonstrict(List<LawToc> lawTocList, WritableOptionCall<LawTocCB, DeleteOption<LawTocCB>> opLambda) {
        return doBatchDeleteNonstrict(lawTocList, createDeleteOption(opLambda));
    }
