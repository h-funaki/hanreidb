...
/**
 * The behavior of (ユーザー)USER as TABLE. <br>
 * <pre>
 * [primary key]
 *     USER_ID
 *
...
public abstract class BsUserBhv extends AbstractBehaviorWritable<User, UserCB> {
     ...
     * @throws SelectEntityConditionNotFoundException When the condition for selecting an entity is not found.
     */
    public OptionalEntity<User> selectByUniqueOf(String mailAddress) {
        return facadeSelectByUniqueOf(mailAddress);
    }

    protected OptionalEntity<User> facadeSelectByUniqueOf(String mailAddress) {
        return doSelectByUniqueOf(mailAddress, typeOfSelectedEntity());
    }

    protected <ENTITY extends User> OptionalEntity<ENTITY> doSelectByUniqueOf(String mailAddress, Class<? extends ENTITY> tp) {
        return createOptionalEntity(doSelectEntity(xprepareCBAsUniqueOf(mailAddress), tp), mailAddress);
    }

    protected UserCB xprepareCBAsUniqueOf(String mailAddress) {
        assertObjectNotNull("mailAddress", mailAddress);
        return newConditionBean().acceptUniqueOf(mailAddress);
    }
     ...
     * <pre>
     * <span style="color: #0000C0">userBhv</span>.<span style="color: #CC4747">loadLoginHistory</span>(<span style="color: #553000">userList</span>, <span style="color: #553000">historyCB</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     ...
     */
    public NestedReferrerListGateway<LoginHistory> loadLoginHistory(List<User> userList, ReferrerConditionSetupper<LoginHistoryCB> refCBLambda) {
        xassLRArg(userList, refCBLambda);
        return doLoadLoginHistory(userList, new LoadReferrerOption<LoginHistoryCB, LoginHistory>().xinit(refCBLambda));
    }
     ...
     * (ログイン履歴)LOGIN_HISTORY by USER_ID, named 'loginHistoryList'.
     * <pre>
     * <span style="color: #0000C0">userBhv</span>.<span style="color: #CC4747">loadLoginHistory</span>(<span style="color: #553000">user</span>, <span style="color: #553000">historyCB</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">historyCB</span>.setupSelect...
     *     <span style="color: #553000">historyCB</span>.query().set...
     *     <span style="color: #553000">historyCB</span>.query().addOrderBy...
     * }); <span style="color: #3F7E5E">// you can load nested referrer from here</span>
     ...
     * <span style="color: #3F7E5E">//    ...</span>
     * <span style="color: #3F7E5E">//});</span>
     * ... = <span style="color: #553000">user</span>.<span style="color: #CC4747">getLoginHistoryList()</span>;
     * </pre>
     * About internal policy, the value of primary key (and others too) is treated as case-insensitive. <br>
     * The condition-bean, which the set-upper provides, has settings before callback as follows:
     * <pre>
     ...
     * @return The callback interface which you can load nested referrer by calling withNestedReferrer(). (NotNull)
     */
    public NestedReferrerListGateway<LoginHistory> loadLoginHistory(User user, ReferrerConditionSetupper<LoginHistoryCB> refCBLambda) {
        xassLRArg(user, refCBLambda);
        return doLoadLoginHistory(xnewLRLs(user), new LoadReferrerOption<LoginHistoryCB, LoginHistory>().xinit(refCBLambda));
    }
     ...
     */
    public List<ClsUserStatus> pulloutClsUserStatus(List<User> userList)
    { return helpPulloutInternally(userList, "clsUserStatus"); }
    ...
    /**
     * Extract the value list of (single) unique key mailAddress.
     * @param userList The list of user. (NotNull, EmptyAllowed)
     * @return The list of the column value. (NotNull, EmptyAllowed, NotNullElement)
     */
    public List<String> extractMailAddressList(List<User> userList)
    { return helpExtractListInternally(userList, "mailAddress"); }
     ...
     * </pre>
     * @param user The entity of update. (NotNull, PrimaryKeyNotNull, ConcurrencyColumnNotNull)
     ...
     * <span style="color: #0000C0">userBhv</span>.<span style="color: #CC4747">updateNonstrict</span>(user);
     * </pre>
     ...
     * @throws EntityAlreadyExistsException When the entity already exists. (unique constraint violation)
     */
    public void updateNonstrict(User user) {
        doUpdateNonstrict(user, null);
    }
     ...
     * @throws EntityAlreadyExistsException When the entity already exists. (unique constraint violation)
     */
    public void insertOrUpdateNonstrict(User user) {
        doInsertOrUpdateNonstrict(user, null, null);
    }
     ...
     * <span style="color: #3F7E5E">// (auto-increment for version number is valid though non-exclusive control)</span>
     * <span style="color: #3F7E5E">//user.setVersionNo(value);</span>
     * <span style="color: #0000C0">userBhv</span>.<span style="color: #CC4747">deleteNonstrict</span>(user);
     * </pre>
     * @param user The entity of delete. (NotNull, PrimaryKeyNotNull)
     * @throws EntityAlreadyDeletedException When the entity has already been deleted. (not found)
     * @throws EntityDuplicatedException When the entity has been duplicated.
     */
    public void deleteNonstrict(User user) {
        doDeleteNonstrict(user, null);
    }
     ...
     * </pre>
     * @param userList The list of the entity. (NotNull, EmptyAllowed, PrimaryKeyNotNull, ConcurrencyColumnNotNull)
     ...
     * @throws EntityAlreadyDeletedException When the entity has already been deleted. (not found)
     */
    public int[] batchUpdateNonstrict(List<User> userList) {
        return doBatchUpdateNonstrict(userList, null);
    }
     ...
     * @throws EntityAlreadyDeletedException When the entity has already been deleted. (not found)
     */
    public int[] batchDeleteNonstrict(List<User> userList) {
        return doBatchDeleteNonstrict(userList, null);
    }
     ...
     * <span style="color: #3F7E5E">// (auto-increment for version number is valid though non-exclusive control)</span>
     * <span style="color: #3F7E5E">//user.setVersionNo(value);</span>
     * <span style="color: #0000C0">userBhv</span>.<span style="color: #CC4747">varyingUpdateNonstrict</span>(user, <span style="color: #553000">op</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">op</span>.self(<span style="color: #553000">cb</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *         <span style="color: #553000">cb</span>.specify().<span style="color: #CC4747">columnXxxCount()</span>;
     *     }).plus(1); <span style="color: #3F7E5E">// XXX_COUNT = XXX_COUNT + 1</span>
     * });
     ...
     * @throws EntityAlreadyExistsException When the entity already exists. (unique constraint violation)
     */
    public void varyingUpdateNonstrict(User user, WritableOptionCall<UserCB, UpdateOption<UserCB>> opLambda) {
        doUpdateNonstrict(user, createUpdateOption(opLambda));
    }
     ...
     * @throws EntityAlreadyExistsException When the entity already exists. (unique constraint violation)
     */
    public void varyingInsertOrUpdateNonstrict(User user, WritableOptionCall<UserCB, InsertOption<UserCB>> insertOpLambda, WritableOptionCall<UserCB, UpdateOption<UserCB>> updateOpLambda) {
        doInsertOrUpdateNonstrict(user, createInsertOption(insertOpLambda), createUpdateOption(updateOpLambda));
    }
     ...
     * @throws EntityDuplicatedException When the entity has been duplicated.
     */
    public void varyingDeleteNonstrict(User user, WritableOptionCall<UserCB, DeleteOption<UserCB>> opLambda) {
        doDeleteNonstrict(user, createDeleteOption(opLambda));
    }
     ...
     * @return The array of updated count. (NotNull, EmptyAllowed)
     */
    public int[] varyingBatchUpdateNonstrict(List<User> userList, WritableOptionCall<UserCB, UpdateOption<UserCB>> opLambda) {
        return doBatchUpdateNonstrict(userList, createUpdateOption(opLambda));
    }
     ...
     * @return The array of deleted count. (NotNull, EmptyAllowed)
     */
    public int[] varyingBatchDeleteNonstrict(List<User> userList, WritableOptionCall<UserCB, DeleteOption<UserCB>> opLambda) {
        return doBatchDeleteNonstrict(userList, createDeleteOption(opLambda));
    }
