...
/**
 * The referrer loader of ([区分値]元号)CLS_ERA as TABLE. <br>
 * <pre>
 * [primary key]
 *     ERA_CODE
 *
 ...
 */
public class LoaderOfClsEra {

    // ===================================================================================
    //                                                                           Attribute
    //                                                                           =========
    protected List<ClsEra> _selectedList;
    protected BehaviorSelector _selector;
    protected ClsEraBhv _myBhv; // lazy-loaded

    // ===================================================================================
    //                                                                   Ready for Loading
    //                                                                   =================
    public LoaderOfClsEra ready(List<ClsEra> selectedList, BehaviorSelector selector)
    { _selectedList = selectedList; _selector = selector; return this; }

    protected ClsEraBhv myBhv()
    { if (_myBhv != null) { return _myBhv; } else { _myBhv = _selector.select(ClsEraBhv.class); return _myBhv; } }
     ...
     * <pre>
     * <span style="color: #0000C0">clsEraBhv</span>.<span style="color: #994747">load</span>(<span style="color: #553000">clsEraList</span>, <span style="color: #553000">eraLoader</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     *     <span style="color: #553000">eraLoader</span>.<span style="color: #CC4747">loadJudgement</span>(<span style="color: #553000">judgementCB</span> <span style="color: #90226C; font-weight: bold"><span style="font-size: 120%">-</span>&gt;</span> {
     ...
     * });
     * for (ClsEra clsEra : <span style="color: #553000">clsEraList</span>) {
    ...
    //                                                                            Accessor
    //                                                                            ========
    public List<ClsEra> getSelectedList() { return _selectedList; }
