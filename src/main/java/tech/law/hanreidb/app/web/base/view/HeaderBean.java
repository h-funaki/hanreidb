 ...
 */
package tech.law.hanreidb.app.web.base.view;
...
public class HeaderBean { // #change_it #delete_ifapi
    ...
    public HeaderBean(HanreidbUserBean userBean) {
        this.memberId = userBean.getUserId();
        this.memberName = userBean.getUserName();
        this.isLogin = true;
    }
