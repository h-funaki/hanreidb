 ...
 * Copyright(c) u-next.
 */
package tech.law.hanreidb.app.base.core.exception.system;
 ...
 * @author jflute
 */
public class NxSystemException extends RuntimeException {
     ...
     */
    public NxSystemException(String debugMsg) {
        super(debugMsg);
    }
     ...
     */
    public NxSystemException(String debugMsg, Throwable cause) {
