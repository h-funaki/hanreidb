...
import tech.law.hanreidb.app.web.base.view.HeaderBean;
import tech.law.hanreidb.mylasta.action.HanreidbHtmlPath;
 ...
 * @author jflute
 */
public abstract class HanreidbBaseAction extends TypicalAction // has several interfaces for direct use
        implements LaValidatable<HanreidbMessages>, HanreidbHtmlPath {
    ...
    @Override
    protected OptionalThing<HanreidbUserBean> getUserBean() { // application may call, overriding for co-variant
    ...
    @Override
    public ActionValidator<HanreidbMessages> createValidator() { // for co-variant
        return super.createValidator();
    }

    @Override
    public HanreidbMessages createMessages() { // application may call
        return new HanreidbMessages(); // overriding to change return type to concrete-class
    }
